                    ...
                    <div className="flex flex-col overflow-y-auto md:flex-row">
                        <div className="h-32 md:h-auto md:w-1/2">
                            <Image
                                ...
                                src="/leonardo-marinho-n6zdsEq8I3g-unsplash.jpg"
                                alt="side ilustrative image"
                                layout="responsive"
                                width={400}
                                height={600}
                            />
                            ...
                            <div className="w-full">
                                ...
                                <label className="block text-sm">
                                    ...
                                    <input
                                        ...
                                        placeholder="Please write yout email"
                                        value={login}
                                ...
                                <a
                                    className="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-teal-600 border border-transparent rounded-lg active:bg-teal-600 hover:bg-teal-700 focus:outline-none focus:shadow-outline-teal"
                                    onClick={() =>
